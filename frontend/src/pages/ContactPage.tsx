...
const ContactPage = () => {
  ...
  return (
    <div className="space-y-10">
      ...
      />
      <Section>
        <div className="space-y-3 rounded-2xl bg-neutral-900 border-2 border-amber-500/40 shadow-lg p-6 grid gap-8 md:grid-cols-[minmax(0,1.6fr)_minmax(0,1fr)] items-start">
          <Card
